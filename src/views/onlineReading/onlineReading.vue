<template>
  <div class="onlineReading" >
    <div class="bookCard">
      <a-card hoverable style="width: 300px;margin:40px;border-radius:36px;" v-for="(item,index) in bookList" :key="index">
        <img
          slot="cover"
          alt="example"
        ...
        <a-card-meta :title="item.bookName" :description="item.description">
        </a-card-meta>
      </a-card>
    </div>
    <!-- 在线阅读弹窗 -->
